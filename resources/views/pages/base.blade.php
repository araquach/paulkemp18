...
@include('layouts.partials.head', [
	...
	'ogimage' => url('/') . '/images/base/base_meta_fb.jpg',
...
<div id="base">
  <div class="columns section is-size-5-mobile">
			...
			<h1 class="title is-4 has-text-primary">Our Amazing New Hair Academy</h1>
		...
		<a href="{{ URL::to('models') }}" target="_blank" class="button is-primary">Register Here &gt;</a>
