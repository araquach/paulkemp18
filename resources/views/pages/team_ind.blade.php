...
@include('layouts.partials.head', [
	'description' => $team_member->para1 . $team_member->para2,
	...
	'ogimage' => url('/') . '/images/staff/meta/' . $team_member->class,
...
<div id="team_abi" class="team_pic"></div>
	...
	<p class="team_ind_price">Average Cut &amp; Colour price with Abi : &pound;{{ $team_member->price }}*</p>
