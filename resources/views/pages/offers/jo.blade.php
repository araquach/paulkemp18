...
@include('layouts.partials.head', [
	...
	'ogimagewidth' => '1200',
	'ogimageheight' => '628',
	'title' => 'Paul Kemp Hairdressing - Offer with Jo - Hairdressers in Warrington'
	])
...
<div id="ind-offer">
	<div class="columns">
		<div class="column is-8">
			<div class="top section">
				<h2 class="title is-2 is-size-4-mobile has-text-primary">Special offer with Jo</h2>
				<p class="is-size-5">Jo is one of the longest standing members of th PK team and is a sought after hairdreser.</p>
	...
	<figure class="image">
		{{ Html::image('/images/offer/individual/jo_montage.png') }}
	</figure>
	<div class="columns">
		<div class="column is-8">
			<div class="section">
				<p class="is-size-5"><strong>Come in for a FREE consultation and if you like the ideas Jo comes up with then book in to get 25% off your visit!</strong></p>
				...
				<div id="fb-like">
				<div class="fb-like" data-href="{{ URL::to('offer/jo') }}" data-width="250" data-layout="standard" data-action="like" data-size="large" data-show-faces="false" data-share="true"></div>
				</div>
			</div>
		</div>
	</div>
