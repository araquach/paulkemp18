	...
	<div class="columns">
		<div class="column is-8">
			<div class="top section">
				<h2 class="title is-2 is-size-4-mobile has-text-primary">Special offer with David for new clients</h2>
				...
				<p>He's now fully settled into the PK team and is creating some stunning looks!</p>
